<template>
  <div>
    <svg class="button-icon h-60 w-160" fill="#EA9209" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 340 340" xml:space="preserve">
  ...
  <br>
  <br>
  <h3 class="font-sans accent-gray-700" > Lembre-se, se você estiver em perigo, não hesite
  <br> em ligar para a polícia! (190).
  <br> Seja breve na descrição! </h3>
  <br>
